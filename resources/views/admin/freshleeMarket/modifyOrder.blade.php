...
@section('main')
    ...
    <div class="card mb-2">
        <div class="card-body text-sm">
            <h5>Modify User Order</h5>
            <hr>
            <div class="row align-items-start">
                <div class="col-12 col-md-8" style="line-height: 4px;">
                    <p>Booking ID: <span class="fw-bold bg-warning">{{ $booking_id }}</span></p>
                    <p>Customer Name: <span class="fw-bold text-md">{{ $customer_name }}</span></p>
                </div>
                <div class="col-12 col-md-4 text-end">
                    <button class="btn btn-md btn-outline-success" id="add_btn">
                        <i class="tf-icons bx bx-plus-medical"></i>Add New Item
                    </button>
                </div>
            </div>
        </div>
    </div>
    <div class="card mb-2" id="add_item_form" style="display: none;">
        <div class="card-body">
            <form action="{{ route('admin.user.order.create') }}" method="POST" autocomplete="off"
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-md-4">
                        ...
                        <select class="form-select" id="item_cd" name="item_cd" required>
                    ...
                    <div class="mb-3 col-sm-12 col-md-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="item_quantity" name="item_quantity"
                    ...
                    <div class="mb-3 col-sm-12 col-md-3">
                        ...
                        <select class="form-select" id="qty_unit" name="qty_unit" required>
                    ...
                    <div class="row col-12 col-md-6">
                        <div class="col-10">
                            <form action="{{ route('admin.user.order.update') }}" method="POST" id="update_order_table"
                                ...
                                <input type="hidden" class="form-control" name="item_cd" value="{{ $order->item_cd }}">
                                ...
                                <button type="submit" class="submit btn btn-md btn-primary"
                        ...
                        <div class="col-2">
                            <form action="{{ route('admin.user.order.delete') }}" method="post">
                                ...
                                <button type="submit" class="btn btn-md btn-danger delete-btn"
